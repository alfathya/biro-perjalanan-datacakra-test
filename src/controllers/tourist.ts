...
class TouristController {
  ...
  static async getTouristProfile(
    req: Request,
    res: Response<ApiResponse>,
    next: NextFunction
  ) {
  ...
  static async updateTouristProfile(
    req: Request<{}, {}, UpdateTouristProfile>,
    res: Response<ApiResponse>,
    next: NextFunction
  ) {
    try {
      ...
      const tourists = await TouristService.updateTouristProfile(userID, data);
      res.status(200).json({
        success: true,
        message: "Tourist list retrieved successfully",
        data: tourists,
  ...
  static async updateTouristByEmployee(
    req: Request<{ id: string }, {}, UpdateTouristProfile>,
    res: Response<ApiResponse>,
    next: NextFunction
  ) {
    try {
  ...
  static async deleteTourist(req: Request, res: Response, next: NextFunction) {
    try {
      const touristId = req.params.id;
      await TouristService.deleteTouristById(touristId);
