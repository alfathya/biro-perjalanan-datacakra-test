...
import { updateTouristProfileSchema } from "../validator/index.validator";
...
router.patch(
  ...
  TouristController.updateTouristByEmployee
);
router.patch(
  "/profile",
  authenticate,
...
router.get(
  ...
  authenticate,
  requireEmployee,
  TouristController.getTouristList
);
router.get(
  "/detail/:id",
  authenticate,
  requireEmployee,
  TouristController.getDetailTourist
);
